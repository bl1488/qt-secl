...
#define GlobalLogInfo(...)    log_wrapper::GlobalLog(spdlog::level::info,  __VA_ARGS__)

#define GlobalLogWarning(...) log_wrapper::GlobalLog(spdlog::level::warn,  __VA_ARGS__)

#define GlobalLogError(...)   log_wrapper::GlobalLog(spdlog::level::err,   __VA_ARGS__)

#define GlobalLogDebug(...)   log_wrapper::GlobalLog(spdlog::level::debug, __VA_ARGS__)
