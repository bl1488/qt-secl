...
Q_CONSTINIT static const qt_meta_stringdata_net__Worker_t qt_meta_stringdata_net__Worker = {
    {
        ...
        QT_MOC_LITERAL(79, 17),  // "RequestClientInfo"
        QT_MOC_LITERAL(97, 20),  // "RequestClientInfoAll"
        QT_MOC_LITERAL(118, 15),  // "ClientInfoReady"
        QT_MOC_LITERAL(134, 10),  // "ClientInfo"
        QT_MOC_LITERAL(145, 4),  // "info"
        QT_MOC_LITERAL(150, 7),  // "DoWrite"
        QT_MOC_LITERAL(158, 11),  // "DoAddClient"
        QT_MOC_LITERAL(170, 14),  // "DoRemoveClient"
        QT_MOC_LITERAL(185, 19)   // "DoClientInfoRequest"
    },
    "net::Worker",
    "Write",
    "",
...
Q_CONSTINIT const QMetaObject net::Worker::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_net__Worker_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<ClientInfo, std::false_type>,
        // method 'DoWrite'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::uint64_t, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
...
void net::Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->RequestClientInfo((*reinterpret_cast< std::add_pointer_t<std::uint64_t>>(_a[1]))); break;
        case 4: _t->RequestClientInfoAll(); break;
        case 5: _t->ClientInfoReady((*reinterpret_cast< std::add_pointer_t<ClientInfo>>(_a[1]))); break;
        ...
        {
            using _t = void (Worker::*)(std::uint64_t );
            if (_t _q_method = &Worker::RequestClientInfo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        ...
        {
            using _t = void (Worker::*)(ClientInfo );
...
// SIGNAL 3
void net::Worker::RequestClientInfo(std::uint64_t _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 5
void net::Worker::ClientInfoReady(ClientInfo _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
